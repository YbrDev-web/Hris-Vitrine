...
<section class="d-flex align-items-center justify-content-center min-vh-100 bg-light">
  <div class="card shadow-lg border-0 p-4" style="max-width: 420px; width: 100%; border-radius: 12px;">
    ...
    <div class="d-grid gap-3">
        ...
        <button onclick="openLinkedInPopup(LinkedIn)" class="btn btn-outline-primary w-100 mb-3"><a href="https://www.gmail.com/login" target="_blank" aria-label="LinkedIn" class="mx-2">
            Continuer avec Google
        </button>
        <button onclick="openLinkedInPopup()" class="btn btn-outline-primary w-100 mb-3"><a href="https://www.microsoft.com/login" target="_blank" aria-label="LinkedIn" class="mx-2">
